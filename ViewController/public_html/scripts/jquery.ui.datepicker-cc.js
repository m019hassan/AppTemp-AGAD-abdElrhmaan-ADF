...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		changeMonth: true, // True if month can be selected directly, false if only prev/next mahmoud
		changeYear: true, // True if year can be selected directly, false if only prev/next mahmoud

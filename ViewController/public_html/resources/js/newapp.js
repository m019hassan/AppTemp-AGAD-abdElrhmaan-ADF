  ...
  if (coordinatesPoint) {
    require([
      ...
      const investmentLands = new FeatureLayer({
        url: "https://services.arcgis.com/oRVAh9p991ohElGI/ArcGIS/rest/services/Investment_map_238/FeatureServer/2",
      });
      // splitting the input
    ...
    require([
      ...
      view2.on("click", function (evt) {
        ...
        console.log(adfLong, adfLat);
        // console.log(graphic2.geometry.x, adfLat);

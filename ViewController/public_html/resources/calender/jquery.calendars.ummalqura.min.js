/* http://keith-wood.name/calendars.html
   ...
   Please attribute the author if you use it. */(function ($) {

    function UmmAlQuraCalendar(a) {
    ...
    {
        name : 'UmmAlQura', hasYearZero : false, minMonth : 1, firstMonth : 1, minDay : 1, regionalOptions :  {
            '' :  {
        ...
        leapYear : function (a) {
            ...
            return (this.daysInYear(b.year()) === 355)
        },
        ...
        toJD : function (a, b, c) {
            ...
            var e = (12 * (d.year() - 1)) + d.month() - 15292;
            var f = d.day() + j[e - 1] - 1;
            return f + 2400000 - 0.5
        },
        fromJD : function (a) {
            var b = a - 2400000 + 0.5;
            var c = 0;
            ...
            var d = c + 15292;
            var e = Math.floor((d - 1) / 12);
            var f = e + 1;
            var g = d - 12 * e;
            var h = b - j[c - 1] + 1;
            return this.newDate(f, g, h)
        },
        isValid : function (a, b, c) {
            var d = $.calendars.baseCalendar.prototype.isValid.apply(this, arguments);
            if (d) {
                a = (a.year != null ? a.year : a);
                d = (a >= 1276 && a <= 1500)
            }
            return d
        },
        _validate : function (a, b, c, d) {
            var e = $.calendars.baseCalendar.prototype._validate.apply(this, arguments);
            if (e.year < 1276 || e.year > 1500) {
